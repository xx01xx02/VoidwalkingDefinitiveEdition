...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create() {
		...
		var menuBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image('thebg'));
		...
		var comp:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('menucomp'));
		comp.setGraphicSize(Std.int(comp.width * 1));
		comp.updateHitbox();
		comp.screenCenter();
